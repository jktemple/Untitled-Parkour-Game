...
public class LobbyCreateUI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        lobbyNameButton.onClick.AddListener(() => {
            InputWindowUI.Show_Static("Lobby Name", lobbyName, "abcdefghijklmnopqrstuvxywzABCDEFGHIJKLMNOPQRSTUVXYWZ .,-", 20,
            () => {
                // Cancel
            },
            (string lobbyName) => {
        ...
        maxPlayersButton.onClick.AddListener(() => {
            InputWindowUI.Show_Static("Max Players", maxPlayers,
            () => {
                // Cancel
            },
            (int maxPlayers) => {
